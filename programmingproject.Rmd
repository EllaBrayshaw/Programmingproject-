...
To look further into optimal values for $\gamma$, I will re-create the plot for only the suitable values of $\lambda$ mentioned above.  
...
plot(sub1$gamma, sub1$T1s)
plot(sub2$gamma, sub2$T1s)
...
I will now look at the optimal values for the type II error rate 
...
```{r}
# By inspection can see Type 2 equal one see what values of gamma 
...
sub7 <- seq_T2s_bind[seq_T2s_bind$lambda == 0.94, ]
